...
// 	state->numActions++;
	...
	// BUG: Number of actions doesn't increase.
...
int cardEffectSeaHag(struct gameState * state, int handPos)
{
	int i = 0;
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
    ...
    switch( card ) 
    {
        ...
        case sea_hag:
        	return cardEffectSeaHag(state, handPos);
        case treasure_map:
